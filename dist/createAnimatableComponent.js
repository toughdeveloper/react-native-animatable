...
function AnimatableComponent(props){_classCallCheck(this,AnimatableComponent);var _this=_possibleConstructorReturn(this,(AnimatableComponent.__proto__||Object.getPrototypeOf(AnimatableComponent)).call(this,
props));_initialiseProps.call(_this);

var animationValue=new _reactNative.Animated.Value(
getAnimationOrigin(0,_this.props.direction));
...
}_createClass(AnimatableComponent,[{key:'initializeTransitionState',value:function initializeTransitionState(

transitionKeys){
var transitionValues={};
var styleValues={};

var currentTransitionValues=(0,_getStyleValues2.default)(
transitionKeys,
this.props.style);
...
var missingKeys=transitionKeys.filter(
function(key){return!_this2.state.transitionValues[key];});

if(missingKeys.length){
var transitionState=this.initializeTransitionState(missingKeys);
transitionValues=_extends({},
transitionValues,
transitionState.transitionValues);

currentTransitionValues=_extends({},
currentTransitionValues,
transitionState.currentTransitionValues);

transitionStyle=_extends({},
transitionStyle,
...
props.animation,delay=props.delay,duration=props.duration,easing=props.easing,transition=props.transition,onAnimationBegin=props.onAnimationBegin,onAnimationEnd=props.onAnimationEnd;
...
toValues,duration,easing,delay){var _this7=this;var
...
toValues,duration,easing,delay){var _this8=this;
...
return(
_react2.default.createElement(Animatable,_extends({
ref:this.handleRef,
style:[
style,
...
restProps,{__source:{fileName:_jsxFileName,lineNumber:544}})));


}}]);return AnimatableComponent;}(_react.Component),_class.displayName='withAnimatable('+wrappedComponentName+')',_class.propTypes={animation:_propTypes2.default.oneOfType([_propTypes2.default.string,_propTypes2.default.object]),duration:_propTypes2.default.number,direction:_propTypes2.default.oneOf(['normal','reverse','alternate','alternate-reverse']),delay:_propTypes2.default.number,easing:_propTypes2.default.oneOfType([_propTypes2.default.oneOf(Object.keys(_easing2.default)),_propTypes2.default.func]),iterationCount:function iterationCount(props,propName){var val=props[propName];if(val!=='infinite'&&!(typeof val==='number'&&val>=1)){return new Error('iterationCount must be a positive number or "infinite"');}return null;},onAnimationBegin:_propTypes2.default.func,onAnimationEnd:_propTypes2.default.func,style:_propTypes2.default.oneOfType([_propTypes2.default.number,_propTypes2.default.array,_propTypes2.default.object]),transition:_propTypes2.default.oneOfType([_propTypes2.default.string,_propTypes2.default.arrayOf(_propTypes2.default.string)]),useNativeDriver:_propTypes2.default.bool},_class.defaultProps={animation:undefined,delay:0,direction:'normal',duration:undefined,easing:undefined,iterationCount:1,onAnimationBegin:function onAnimationBegin(){},onAnimationEnd:function onAnimationEnd(){},style:undefined,transition:undefined,useNativeDriver:false},_initialiseProps=function _initialiseProps(){var _this9=this;this.ref=null;this.handleRef=function(ref){_this9.ref=ref;};},_temp;
